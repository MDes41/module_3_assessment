class SearchController < ApplicationController
  def index
    conn = Faraday.new(:url => "https://api.bestbuy.com/v1/stores(area(80202,25))?format=json&show=longName,distance,city,phone,storeType&apiKey=#{ENV['BEST_BUY_KEY']}") do |faraday|
